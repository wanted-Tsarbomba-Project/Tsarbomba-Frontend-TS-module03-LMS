...
const modalClasses = {
  ...
  textWrap:
    "mt-8 flex flex-1 flex-col items-center justify-center px-8 pb-24 max-[560px]:mt-5 max-[560px]:px-5 max-[560px]:pb-32",
  title:
  ...
  buttonWrap:
    "absolute bottom-8 flex w-full justify-center gap-3 px-5 max-[560px]:bottom-5 max-[560px]:flex-col",
  button:
